...
SQL;
      ...
      <div class="row py-2">
            <div class="col-2 text-right"><img src="$src" class="product"></div>
             <div class="col-10">
                   <h6 class="mx-4"><a href="product-detail.php?id=$data->id">$n</a></h6>
      ...
      HTML;
            ...
            echo <<<HTML
<div class="row py-2">
      <div class="col text-left">Total delivery cost :</div>
      <div class="col text-right">$f_dvr_cost</div>
</div>   
<div class="row pt-4 pb-2">
      <div class="col text-left">Grand total :</div>
...
<div class="row pt-3 pb-2">
      <div class="col text-left">Payment methods :</div>
      <div class="col text-right">$pay</div>
</div>
<div class="row pt-3 pb-2">
      <div class="col text-left">Payment notification :</div>
