...
<head>
    ...
    justify-content: center;
        ...
        div.card {
            min-width: 130px;
            max-width: 150px;
            border: 1px solid #17a2b8; /* Matching border with navbar/footer */
            border-radius: 10px;
        }
        ...
        /* Card text styles */
        div.card h6 {
            color: #28a745; /* Greenish color matching the theme */
        }

        div.card .btn-info {
            background-color: #17a2b8; /* Matching button color with navbar */
            border: none;
        }
        ...
        /* Heading styles */
        h6 {
            color: #28a745; /* Greenish heading to match card text */
        }
